  ...
  module Handlers
    class Who < Handler
      route(/^invite <@([^>]+)>/i, :invite_kiosk, help: {
              'invite @username' => 'send you the kiosk invite link for the user mentioned'
            })

      route(/^who is in the office|who\'s in the office|who\'s here|who is here/i, :who, help: {
              'who is in the office?' => 'lists all of the people currently at 150 Court.'
            })
